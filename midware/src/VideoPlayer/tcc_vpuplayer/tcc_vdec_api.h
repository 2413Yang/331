...
extern int tcc_vdec_init(uint32_t view_pos, uint32_t view_size, uint32_t img_align, uint32_t img_fmt, int videoOnTop);
...
#define	VIOC_VIQE						(4)
		#define VIOC_VIQE_RDMA_00		(0)
		#define VIOC_VIQE_RDMA_01		(1)
		#define VIOC_VIQE_RDMA_02		(2)
		#define VIOC_VIQE_RDMA_03		(3)
		#define VIOC_VIQE_RDMA_06		(4)
		#define VIOC_VIQE_RDMA_07		(5)
		#define VIOC_VIQE_RDMA_10		(6)
		#define VIOC_VIQE_RDMA_11		(7)
		#define VIOC_VIQE_RDMA_12		(8)
		#define VIOC_VIQE_VIN_03		(9)
...
#define	VIOC_DEINTLS					(5)
		...
		#define VIOC_DEINTLS_VIN_03 	(VIOC_VIQE_VIN_03)
